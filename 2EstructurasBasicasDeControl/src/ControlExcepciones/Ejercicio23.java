...
/*
 *Función que reciba como parámetro un número entero, y 
 *devuelva su mayor divisor distinto del propio número. 
 *Ejemplos: el mayor divisor de 6 es 3, el mayor divisor 
 *de 15 es 5, el mayor divisor de 23 es 1.
 */
